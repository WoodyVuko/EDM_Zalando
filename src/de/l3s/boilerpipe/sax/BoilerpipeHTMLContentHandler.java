...
public class BoilerpipeHTMLContentHandler implements ContentHandler {
	...
	private final Stack<Pair<String, List<Pair<String, String>>>> tagStack = new Stack<>();
	
	Pair<String, List<Pair<String, String>>> currentTag = null;
	...
	public void flushBlock() {
		...
		TextBlock tb = new TextBlock(textBuffer.toString().trim(),
				...
				numWordsInWrappedLines, numWrappedLines, offsetBlocks, currentTag);
